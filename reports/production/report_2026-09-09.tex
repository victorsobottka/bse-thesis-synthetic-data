...
\midrule
GJR-GARCH & \textbf{2.5429} & 2.7048 & 2.3810 & 2.5429 \\
FinGAN & 2.7143 & 2.4857 & 2.9428 & 2.7143 \\
QuantGAN & 2.9119 & 3.0619 & 2.7619 & 2.9119 \\
GARCH & 2.9500 & 3.1381 & 2.7619 & 2.9500 \\
TimeGAN & 3.8810 & 3.6095 & 4.1524 & 3.8810 \\
CONTROL: shuffled real & --- & --- & --- & --- \\
\bottomrule
\end{tabular}}

\smallskip
The best composite score is 2.543.}
...
Across 24,758 market-days, the Gaussian benchmark predicts $<0.01$ days with $|r|>5\sigma$. We observed 76 --- all five markets exceed the Gaussian prediction by a factor exceeding 10{,}000 (Gaussian: once per 6,922 years; observed: $\approx$once per year per market). MOEX alone had 21.
...
Rankings are computed among the generators present in \texttt{overall\_performance.csv} for this run (markets: BOVESPA, FTSE, MOEX, NIFTY50, SHANGHAI). The shuffled control is appended as a reference line with NaN ranks, shown as em-dashes.
...
\textbf{Walk-forward validation.} 5 rolling fold(s) per market enable mean\,$\pm$\,std across folds rather than a single metric estimate. Budgets are equalised on generator updates across all three models (Yoon et al.'s four-phase pre-training is reported separately), so TimeGAN's temporal ranking reflects its architecture at parity, not an unequal training budget.
...
\midrule
FinGAN & 0.0022 $\pm$ 0.0006 & 0.0533 $\pm$ 0.0572 & 0.6196 $\pm$ 0.0741 \\
GARCH & 0.0022 $\pm$ 0.0007 & 0.0411 $\pm$ 0.0193 & 0.6632 $\pm$ 0.0965 \\
GJR-GARCH & 0.0022 $\pm$ 0.0006 & 0.0332 $\pm$ 0.0289 & 0.6446 $\pm$ 0.1135 \\
QuantGAN & 0.0041 $\pm$ 0.0039 & 0.0394 $\pm$ 0.0507 & 0.6576 $\pm$ 0.2509 \\
TimeGAN & 0.0052 $\pm$ 0.0021 & 0.1134 $\pm$ 0.0613 & 0.8210 $\pm$ 0.1368 \\
\bottomrule
\end{tabular}}

\smallskip
{\small Mean $\pm$ sd across 5 fold(s), market BOVESPA seed 42.}}
...
\midrule
CONTROL: shuffled real & -8.145 & 0.0077 & 0.4219 & 0.9056 & 21 & 496 \\
FinGAN & -8.143 & 0.0117 & 0.2135 & 0.7540 & 19 & 496 \\
GARCH & -8.140 & 0.0177 & 0.0532 & --- & 16 & 496 \\
GJR-GARCH & -8.132 & 0.0177 & 0.0532 & --- & 16 & 496 \\
QuantGAN & -7.998 & 0.0298 & 0.0006 & --- & 10 & 496 \\
TimeGAN & -5.111 & 0.0198 & 0.0298 & --- & 15 & 496 \\
\bottomrule
\end{tabular}}

\smallskip
{\small From \texttt{pooled\_downstream\_utility.csv} (BOVESPA, FTSE, MOEX, NIFTY50, SHANGHAI, seed(s) 42, 43, 44). Lower QLIKE is better. An em-dash means Christoffersen's test was not computed (e.g.\ too few violations to fit the independence statistic).}
...
\clearpage\begin{center}\includegraphics[width=0.85\linewidth,height=0.82\textheight,keepaspectratio]{thesis_results/production/BOVESPA/seed42/BOVESPA_stylized_facts.png}\end{center}\centerline{\small\textit{Stylised facts: synthetic against real daily log returns}}\vspace{6pt}

\clearpage\begin{center}\includegraphics[width=0.85\linewidth,height=0.82\textheight,keepaspectratio]{thesis_results/production/BOVESPA/seed42/BOVESPA_metrics_heatmap.png}\end{center}\centerline{\small\textit{Normalised metrics heatmap}}\vspace{6pt}

\clearpage\begin{center}\includegraphics[width=0.85\linewidth,height=0.82\textheight,keepaspectratio]{thesis_results/production/BOVESPA/seed42/BOVESPA_rank_comparison.png}\end{center}\centerline{\small\textit{Average rank comparison}}\vspace{6pt}
...
Temporal 80/10/10 split (no shuffle). The 80\% training portion feeds GAN training; the 10\% test portion is the evaluation target. Walk-forward validation uses 5 rolling fold(s) within the test portion; each fold retrains the model from scratch on the fold's training segment.
...
\midrule
FinGAN & 9,000 & 45,000 & 172.9 & 55,401 \\
GARCH & --- & --- & 0.0 & 5 \\
GJR-GARCH & --- & --- & 0.0 & 6 \\
QuantGAN & 9,000 & 45,000 & 464.7 & 276,481 \\
TimeGAN & 9,000 & 9,000 & 77.1 & 11,400 \\
\bottomrule
\end{tabular}}
